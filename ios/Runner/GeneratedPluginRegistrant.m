...
#if __has_include(<image_compression_flutter/ImageCompressionFlutterPlugin.h>)
#import <image_compression_flutter/ImageCompressionFlutterPlugin.h>
#else
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  [ImageCompressionFlutterPlugin registerWithRegistrar:[registry registrarForPlugin:@"ImageCompressionFlutterPlugin"]];
